...
declare -a MAP_MATTPOCOCK=(
  ...
  "skills/meta/to-questionnaire:skills/productivity/to-questionnaire"
  "skills/meta/wait-what:skills/productivity/wait-what"
  "skills/meta/writing-for-agents:skills/productivity/writing-for-agents"
  ...
  "skills/tooling/wizard:skills/engineering/wizard"
