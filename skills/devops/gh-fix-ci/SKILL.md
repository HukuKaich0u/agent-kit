...
- If a plan-oriented skill is available, use it; otherwise draft a concise plan inline and request approval before implementing.
...
6. Create a plan.
   - Draft a concise plan and request approval.
