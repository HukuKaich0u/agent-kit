...
```bash
apm install HukuKaich0u/agent-kit/skills/frontend/review-perspectives/frontend-expert
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/frontend/review-perspectives/frontend-expert
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill frontend-expert
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/frontend/review-perspectives/frontend-expert ~/.claude/skills/frontend-expert
```
