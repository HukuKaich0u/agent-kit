...
```bash
apm install HukuKaich0u/agent-kit/skills/frontend/review-perspectives/frontend-ops-expert
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/frontend/review-perspectives/frontend-ops-expert
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill frontend-ops-expert
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/frontend/review-perspectives/frontend-ops-expert ~/.claude/skills/frontend-ops-expert
```
