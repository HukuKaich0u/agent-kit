...
```bash
apm install HukuKaich0u/agent-kit/skills/frontend/review-perspectives/security-expert
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/frontend/review-perspectives/security-expert
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill security-expert
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/frontend/review-perspectives/security-expert ~/.claude/skills/security-expert
```
