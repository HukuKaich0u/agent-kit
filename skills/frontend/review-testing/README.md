...
> Use when auditing test infrastructure — test runner setup and coverage, E2E configuration, VRT setup, coverage merging. Read-only desk review; run it manually per repo.
