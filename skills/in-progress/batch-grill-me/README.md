...
```bash
apm install HukuKaich0u/agent-kit/skills/in-progress/batch-grill-me
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/in-progress/batch-grill-me
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill batch-grill-me
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/in-progress/batch-grill-me ~/.claude/skills/batch-grill-me
```
