...
```bash
apm install HukuKaich0u/agent-kit/skills/in-progress/claude-handoff
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/in-progress/claude-handoff
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill claude-handoff
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/in-progress/claude-handoff ~/.claude/skills/claude-handoff
```
