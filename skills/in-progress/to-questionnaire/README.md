...
```bash
apm install HukuKaich0u/agent-kit/skills/in-progress/to-questionnaire
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/in-progress/to-questionnaire
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill to-questionnaire
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/in-progress/to-questionnaire ~/.claude/skills/to-questionnaire
```
