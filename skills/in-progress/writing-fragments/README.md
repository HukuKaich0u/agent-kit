...
```bash
apm install HukuKaich0u/agent-kit/skills/in-progress/writing-fragments
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/in-progress/writing-fragments
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill writing-fragments
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/in-progress/writing-fragments ~/.claude/skills/writing-fragments
```
