...
```bash
apm install HukuKaich0u/agent-kit/skills/in-progress/writing-shape
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/in-progress/writing-shape
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill writing-shape
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/in-progress/writing-shape ~/.claude/skills/writing-shape
```
