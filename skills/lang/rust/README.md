...
```bash
npx skills add HukuKaich0u/agent-kit --skill rust-best-practices
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/lang/rust ~/.claude/skills/rust-best-practices
```
