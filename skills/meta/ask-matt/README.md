...
```bash
apm install HukuKaich0u/agent-kit/skills/meta/ask-matt
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/meta/ask-matt
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill ask-matt
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/meta/ask-matt ~/.claude/skills/ask-matt
```
