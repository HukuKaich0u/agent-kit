...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/meta/grilling
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill grilling
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/meta/grilling ~/.claude/skills/grilling
```
