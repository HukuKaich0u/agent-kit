...
```bash
apm install HukuKaich0u/agent-kit/skills/meta/skill-finder
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/meta/skill-finder
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill skill-finder
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/meta/skill-finder ~/.claude/skills/skill-finder
```
