...
| T1 | db-migration-safety | `HukuKaich0u/agent-kit/skills/db/migration-safety` | Writing/reviewing a schema migration against live traffic — lock classification, expand-contract, backfill/GSI (Postgres/RDS, MySQL, SQLite/D1/Turso, DynamoDB) |
