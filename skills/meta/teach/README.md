...
```bash
apm install HukuKaich0u/agent-kit/skills/meta/teach
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/meta/teach
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill teach
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/meta/teach ~/.claude/skills/teach
```
