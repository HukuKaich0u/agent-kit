...
```bash
apm install HukuKaich0u/agent-kit/skills/meta/to-questionnaire
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/meta/to-questionnaire
```
...
```bash
npx degit HukuKaich0u/agent-kit/skills/meta/to-questionnaire ~/.claude/skills/to-questionnaire
```
