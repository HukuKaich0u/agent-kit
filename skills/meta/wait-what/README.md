...
```bash
apm install HukuKaich0u/agent-kit/skills/meta/wait-what
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/meta/wait-what
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill wait-what
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/meta/wait-what ~/.claude/skills/wait-what
```
