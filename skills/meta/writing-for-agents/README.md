...
```bash
apm install HukuKaich0u/agent-kit/skills/meta/writing-for-agents
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/meta/writing-for-agents
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill writing-for-agents
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/meta/writing-for-agents ~/.claude/skills/writing-for-agents
```
