...
```bash
apm install HukuKaich0u/agent-kit/skills/tooling/apm-usage
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/tooling/apm-usage
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill apm-usage
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/tooling/apm-usage ~/.claude/skills/apm-usage
```
