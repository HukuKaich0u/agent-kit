...
```bash
apm install HukuKaich0u/agent-kit/skills/tooling/diagnosing-bugs
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/tooling/diagnosing-bugs
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill diagnosing-bugs
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/tooling/diagnosing-bugs ~/.claude/skills/diagnosing-bugs
```
