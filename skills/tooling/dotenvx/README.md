...
```bash
apm install HukuKaich0u/agent-kit/skills/tooling/dotenvx
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/tooling/dotenvx
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill dotenvx
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/tooling/dotenvx ~/.claude/skills/dotenvx
```
