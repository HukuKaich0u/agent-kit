...
```bash
apm install HukuKaich0u/agent-kit/skills/tooling/resolving-merge-conflicts
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/tooling/resolving-merge-conflicts
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill resolving-merge-conflicts
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/tooling/resolving-merge-conflicts ~/.claude/skills/resolving-merge-conflicts
```
