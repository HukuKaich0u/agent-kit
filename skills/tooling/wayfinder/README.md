...
```bash
apm install HukuKaich0u/agent-kit/skills/tooling/wayfinder
```
...
dependencies:
  apm:
    - HukuKaich0u/agent-kit/skills/tooling/wayfinder
```
...
```bash
npx skills add HukuKaich0u/agent-kit --skill wayfinder
```

Or copy the folder in directly:

```bash
npx degit HukuKaich0u/agent-kit/skills/tooling/wayfinder ~/.claude/skills/wayfinder
```
